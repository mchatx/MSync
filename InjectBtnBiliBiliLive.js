...
function LoadButtons() {
	var target = document.getElementsByClassName("nav-switcher open-btn show")[0];
	var ExtContainer = document.createElement('div');
	ExtContainer.id = "Extcontainer";
	target.parentElement.after(ExtContainer);
...
async function WaitUntilLoad(){
	...
	while (true){
		...
		var target = document.getElementsByClassName("nav-switcher open-btn show");
		if (target.length != 0){
