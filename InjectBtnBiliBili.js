//-------------------------------------------  HEAD VARIABLES  -------------------------------------------
const ExtContainerParentID = "arc_toolbar_report";
const TitleCSSSelector = ".tit";
var UID = document.location.toString().replace("https://www.bilibili.com/video/", "");
if (UID.indexOf("?") != -1){
...
function StartHereClick(){
	...
	var tipwrap = document.getElementsByClassName("bilibili-player-dm-tip-wrap");
	if (tipwrap.length != 0){
		tipwrap[0].style.zIndex = 9;
	}
...
function SummonAccModal(Nick) {
	var VideoWrap = document.getElementsByClassName("bilibili-player-video-wrap");
