...
function SendReg(){
	...
	UID = "Twitcast " + title.textContent.substring(title.textContent.lastIndexOf("#"));
...
function LoadButtons() {
	var target = document.getElementsByClassName("tw-player-page__component tw-player-page__player-header");
